            ...
            <div class="panel panel-default corner-radius">
                ...
                <div class="panel-body">
                    <div class="reply-box form box-block">
                        <form:form method="POST" action="${pageContext.request.contextPath}/post" accept-charset="UTF-8" id="thread_create_form" class="create_form" modelAttribute="post">
                            ...
                            <div class="form-group">
                                <form:select cssClass="form-control selectpicker" path="category">
                                    <form:option value="帮助">帮助</form:option>
                                    <form:option value="使用指南">使用指南</form:option>
                                </form:select>
                            </div>
                            <!-- editor start -->
                            ...
                            <div class="form-group">
                                <form:select cssClass="form-control js-tag-tokenizer" path="tag">

                                    <form:option value="Java">Java</form:option>
                                    <form:option value="Java">Python</form:option>
                                </form:select>
                                <small>
                                    请填写标签
                                </small>
